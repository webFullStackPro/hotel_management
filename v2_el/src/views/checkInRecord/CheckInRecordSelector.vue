<template>
  <div class="pop-dialog-container">
    <div class="pop-dialog-main">
      ...
      <el-table-column prop="reservationRecordId" label="预定记录id"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    checkInRecordSelected (row) {
      this.$emit('check-in-record-selected-event', {
